...
Plugin that connects AI agents to the hosted [Grafana Cloud MCP server](https://grafana.com/docs/grafana-cloud/account-management/authentication-and-permissions/access-policies/) for AI-assisted observability workflows.
...
See the [Grafana Cloud MCP documentation](https://grafana.com/docs/grafana-cloud/developer-resources/assistant/configure/cloud-mcp/) for the full tool reference.
